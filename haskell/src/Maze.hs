module Maze where
    ...
    -- | Defines the list of points that make up the maze of MazeGame
    coords :: [Point]
    ...
    -- | List of all the corssroads for the Bosss to make movement choices.
    crossR :: [Point]
    ...
    -- | Takes the list of points turns them into the MazeGame maze
